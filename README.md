...
- AI/ML: Custom Neural Networks for Voice Processing

- API/Logic: Custom-built command handler

--- 

# Целью данного проекта было использование передовых технологий и демонстрация стремления следовать за современными техническими инновациями.

📌 Описание

Этот проект представляет собой реализацию голосового ИИ-ассистента, вдохновленного системой «Джарвис» из вселенной Iron Man. Изначальная идея была взята у Howdyho, однако данный проект является глубокой переработкой. Я полностью переписал код под свои задачи и разработал собственные ИИ-решения для взаимодействия с речью.

Проект был завершен и успешно защищен на «Отлично» в марте 2025 года в рамках индивидуальной проектной деятельности в 11 классе.
...
- AI/ML: Собственные модели для обработки аудио

- Логика: Уникальный обработчик команд и сценариев
---
🎓 Project Defense / Защита проекта
- Date: March 2025

- Grade: Excellent (5/5)

- Status: Successfully demonstrated in practice.
